    ...
    <body class="p-4">
        <div class="max-w-3xl mx-auto overflow-hidden bg-white rounded-lg custom-shadow">
            ...
            <div class="flex">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="p-1 mb-6">
                                ...
                                <p class="pl-2 text-lg font-bold pukimak">
                                    {{ $currentRecord->peserta->utusan->kecamatan }}</p>
                            </div>
                            <div class="p-1 ">
                                <h2 class="text-xs font-semibold text-gray-600">Cabang</h2>
                                <p class="pl-2 text-lg font-bold pukimak">Tilawah Anak</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 bg-white rounded-lg shadow-md" id="timer-container">
                    ...
                    <div class="flex justify-center space-x-4">
                        <button id="startBtn"
                            class="p-2 text-white bg-green-500 rounded-lg hover:bg-green-600">Start</button>
                        <button id="pauseBtn"
                            class="p-2 text-white bg-yellow-500 rounded-lg hover:bg-yellow-600">Pause</button>
                        <button id="restartBtn"
                            class="p-2 text-white bg-red-500 rounded-lg hover:bg-red-600">Restart</button>
                    </div>
                </div>
            </div>
                ...
                <div class="pr-2" style="width: 65%;">
                    <div class="my-slider">
                        @foreach ($records as $record)
                            ...
                            <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                                <h3 class="mb-1 text-xs">Lagu</h3>
                                <p class="text-3xl font-bold">{{ $currentRecord->lagu }}</p>
                            </div>
                            <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            ...
                            <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                                <h3 class="mb-1 text-xs">Suara</h3>
                                <p class="text-3xl font-bold">{{ $currentRecord->suara }}</p>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="flex items-end justify-between px-4 pb-4">
                @if ($previousRecord)
                    <a href="{{ route('nilai-anak.index', $previousRecord->id) }}"
                ...
                @if ($nextRecord)
                    <a href="{{ route('nilai-anak.index', $nextRecord->id) }}"
