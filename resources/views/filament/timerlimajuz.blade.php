...
<body class="p-4">
    <div class="max-w-3xl mx-auto overflow-hidden bg-white rounded-lg custom-shadow">
                ...
                <div class="flex h-full">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="p-1 ">
                            ...
                            <p class="pl-2 text-lg font-bold pukimak">MHQ 5 Juz Tilawah</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="my-slider">
                    @foreach ($records as $record)
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Til Tajwid</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->til_tajwid }}</p>
                        </div>
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Til Lagu</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->til_lagu }}</p>
                        </div>
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Til Suara</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->til_suara }}</p>
                        </div>
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Til Fashahah</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->til_fashahah }}</p>
                        </div>
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Tah Tahfizh</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->tah_tahfizh }}</p>
                        </div>
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Tah Tajwid</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->tah_tajwid }}</p>
                        </div>
                        <div class="p-2 mx-3 text-center text-white rounded bg-mtq-blue">
                            <h3 class="mb-1 text-xs">Tah Fashahah</h3>
                            <p class="text-3xl font-bold">{{ $currentRecord->tah_fashahah}}</p>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="flex items-end justify-between px-4 pb-4">
            @if ($previousRecord)
                <a href="{{ route('nilai-limajuz.index', $previousRecord->id) }}" class="px-6 py-2 text-sm font-semibold text-white bg-gray-800 rounded">Back</a>
            @else
                <button class="px-6 py-2 text-sm font-semibold text-white bg-gray-400 rounded" disabled>Back</button>
            @endif

            @if ($nextRecord)
                <a href="{{ route('nilai-limajuz.index', $nextRecord->id) }}" class="px-6 py-2 text-sm font-semibold text-white bg-gray-800 rounded">Next</a>
            @else
