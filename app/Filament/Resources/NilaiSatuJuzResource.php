...
use App\Filament\Resources\NilaiSatuJuzResource\Pages;
use App\Filament\Resources\NilaiSatuJuzResource\RelationManagers;

class NilaiSatuJuzResource extends Resource
{
    protected static ?string $model = NilaiSatuJuz::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->live(onBlur: true)
                ->disabled()
                ->formatStateUsing(fn(NilaiSatuJuz $record): string => $record->peserta->nama ?? ''),
                Split::make([
                    Section::make([
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('peserta.jenis_kelamin')
                    ->label('Jenis Kelamin')
                    ->formatStateUsing(fn (NilaiSatuJuz $record): string => $record->peserta->jenis_kelamin == 'putra' ? 'L' : 'P'),
    ...
    {
        return [
            'index' => Pages\ManageNilaiSatuJuzs::route('/'),
        ];
    }
}
