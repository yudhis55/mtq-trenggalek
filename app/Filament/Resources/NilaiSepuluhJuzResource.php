                ...
                Split::make([
                    Section::make([
                        TextInput::make('peserta_id')
                            ...
                            ->live(onBlur: true)
                            ->disabled()
                            ->formatStateUsing(fn(NilaiSepuluhJuz $record): string => $record->peserta->nama ?? ''),
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('peserta.jenis_kelamin')
                    ->label('Jenis Kelamin')
                    ->formatStateUsing(fn (NilaiSepuluhJuz $record): string => $record->peserta->jenis_kelamin == 'putra' ? 'L' : 'P'),
